...
<div class="section bg-white">
    ...
    <div class="container">
        ...
        <div class="col-sm-6 post-grid">
            <h3 class="title"><?= Yii::t('app', 'Contact Info') ?></h3>
            <ul class="contact-list-icon">
                ...
                <?php if (Setting::getValue('contact_twitter')) : ?>
                    <li>
                        ...
                        <div class="contact-info-content">
                            <div class="title"><?= Yii::t('app', 'Twitter') ?>:</div>
        ...
        <div class="col-sm-6 post-grid">
            ...
            <h3 class="title"><?= Yii::t('app', 'Drop Us A Few Lines') ?></h3>
            ...
            <div class="pull-left">
                <?= Html::submitButton(Yii::t('app', 'Submit'), ['class' => 'btn btn-primary-magnet btn-block btn-lg-m', 'name' => 'contact-button']) ?>
            </div>
