...
<div class="section">
    <div class="container">
        <div class="col-sm-12">
            <h2 class="block-title"><?= Yii::t('app', 'User Information') ?></h2>
        </div>
        <?php if (!empty($items) && count($items) > 0) : ?>
                ...
                <div class="col-lg-10 col-lg-offset-1">
                    ...
                    <?php $form = ActiveForm::begin(['id' => 'checkout-form']); ?>
                        ...
                        <div class="col-lg-12">
                            ...
                            <?= Html::submitButton($model->isNewRecord ? Yii::t('app', 'Checkout') : Yii::t('app', 'Update'), ['class' => 'btn btn-primary-magnet']) ?>
                            <?= Html::a(Yii::t('app', 'Back'), ['cart'], ['class' => 'btn btn-inverse text-uppercase']) ?>
                        </div>
            ...
            <?php else : ?>
                ...
                <?= Html::a(Yii::t('app', 'Login'), ['/user/login'], ['class' => 'btn btn-primary-magnet']) ?>
            <?php endif; ?>
        <?php else : ?>
