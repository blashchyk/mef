...
<?php if (!empty($hsTree)) : ?>
    ...
    <?= \yii\helpers\Html::a(Yii::t('app', 'Change Tree'), ['view', 'fundId' => $fund->id, 'chenge_tree' => $fund->tree], ['class' => 'change_tree']);?>
    <?= HsView::widget([
        'query' => $fund->tree ? $item->getKartikTreeNodes()->orderBy('root, lft') : KartikTreeNode::find()
