...
use modules\media\models\CategorySearch;
...
class CategoryController extends BaseController
{
    ...
    {
        return [
            'index' => 'media.backend.index',
            'view' => 'media.backend.index',
            'update' => 'media.backend.update',
            'show' => 'media.backend.update',
            'show-list' => 'media.backend.update',
            'sort' => 'media.backend.update',
            'create' => 'media.backend.create',
            'delete' => 'media.backend.delete',
            'delete-list' => 'media.backend.delete',
        ];
    }
